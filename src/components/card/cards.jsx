    ...
    return (
        <div className='text-center'>
            <img src={props.img} alt={props.alt}
                className='w-11/12 mx-auto md:w-4/5 object-cover'
            />
            <p className='text-black font-bold text-md 2xl:text-3xl 2xl:py-3'>{props.work_name}</p>
            <h5 className='text-black font-bold text-xl 2xl:text-4xl 2xl:py-3 '>{props.brand_name}</h5>
            <p className='text-gray-600 font-bold text-xl 2xl:text-3xl '>{props.price}</p>
        </div>
    )
}
